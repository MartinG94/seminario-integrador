...
├── frontend-angular/                           # SPA de producción en Angular 14 + Material Dashboard PRO
...
│   ├── formales/                               # Entregables académicos oficiales en formatos .docx, .odt y .pdf
...
│   ├── BPMN_Proceso_Operativo_Tribunal.md      # Modelo de procesos de negocio en BPMN 2.0
│   ├── ERS-SGD-AVEIT.md                        # Especificación de Requerimientos de Software completa
│   ├── MODELO_DOMINIO_SGD_AVEIT.md             # Diagrama de clases del dominio y diccionario de datos
│   ├── PLANTILLA_CASO_DE_USO.md                # Plantilla estándar institucional para especificación de Casos de Uso
│   ├── PLAN_DE_PROYECTO_SGD_AVEIT.md           # Plan de proyecto institucional completo
...
| :--- | :--- |
| **`docs/`** | **Documentación de Ingeniería de Software y Análisis.** Centraliza todos los documentos de análisis funcional, relevamiento de requerimientos, especificación de actores, modelo de dominio, procesos BPMN y plantillas metodológicas en Markdown (`.md`). |
| **`docs/formales/`** | **Documentos Entregables Institucionales y Académicos.** Contiene las versiones formales presentables del Estudio Inicial y Plan de Proyecto en formatos Word (`.docx`), OpenDocument (`.odt`) y PDF (`.pdf`), junto con los recursos gráficos del marco institucional (`assets/`). |
...
| **`frontend-angular/`** | **SPA Web de Producción.** Aplicación cliente en Angular 14.2+ basada en Material Dashboard PRO, con componentes modulares, tipado TypeScript estricto y configuración Docker. |
